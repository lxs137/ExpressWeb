	...
	Plugin.prototype = {
		...
		expandItem: function(li)
		{
			...
			for(var i=0;i<length;i++)
				li.find("li.dd-item").eq(i).children().css("z-index","-"+i);
...
function initpersondata(obj, data) {
	...
	for (var i = 1; i <= data.length; i++) {
		...
		img2.setAttribute("id", "person_listItem_phone_number"+mdl_id);
		...
		div6.setAttribute("data-mdl-for", "person_listItem_phone_number"+mdl_id++);
		div6.innerHTML = "电话号码";
		...
		img3.setAttribute("id", "person_listItem_id_num"+mdl_id);
		img3.setAttribute("src", "images/person_listItem_id_num.png");
		var div7 = document.createElement("div");
		div10.appendChild(div7);
		div7.setAttribute("class", "mdl-tooltip");
		div7.setAttribute("data-mdl-for", "person_listItem_id_num"+mdl_id++);
		div7.innerHTML = "身份证号";
		...
		img4.setAttribute("id", "person_listItem_address"+mdl_id);
		img4.setAttribute("src", "images/person_listItem_address.png");
		var div9 = document.createElement("div");
		div8.appendChild(div9);
		div9.setAttribute("class", "mdl-tooltip");
		div9.setAttribute("data-mdl-for", "person_listItem_address"+mdl_id++);
 ...
 * @param data
 */
function initstationdata(obj, data) {
	var div = document.getElementById(obj);
	var ol = document.createElement("ol");
	div.appendChild(ol);
	ol.setAttribute("class", "dd-list");
	for (var i = 1; i <= data.length; i++) {
		...
		var div2 = document.createElement("div");
		li.appendChild(div2);
		div2.setAttribute("class", "station_listItem dd-handle mdl-card mdl-shadow--4dp");
		var div3 = document.createElement("div");
		div2.appendChild(div3);
		div3.setAttribute("class", "station_listItem_title mdl-card__title mdl-card--border");
		var span1 = document.createElement("span");
		div3.appendChild(span1);
		var img1 = document.createElement("img");
		span1.appendChild(img1);
...
function initladingdata(obj, data, type) {
	...
	for (var i = 1; i <= data.getLadingInfoList().length; i++) {
		if(data.getLadingInfoList()[i-1].getIsDelivered()=="0")
			continue;
		var li = document.createElement("li");
		ol.appendChild(li);
		li.setAttribute("class", "dd-item");
		...
		var h1 = document.createElement("h3");
		div3.appendChild(h1);
		h1.setAttribute("id", "lading_listItem_id"+mdl_id);
		h1.setAttribute("class", "mdl-card__title-text lading_listItem_id");
		h1.innerHTML = data.getLadingInfoList()[i - 1].getLadingIdNum();//输出Name
		var div4 = document.createElement("div");
		div3.appendChild(div4);
		div4.setAttribute("class", "mdl-tooltip");
		div4.setAttribute("data-mdl-for", "lading_listItem_id"+mdl_id++);
		div4.innerHTML = "货物单号";
		...
		var img1 = document.createElement("img");
		span1.appendChild(img1);
		img1.setAttribute("id", "lading_listItem_name"+mdl_id);
		img1.setAttribute("src", "images/lading_listItem_name.png");
		var div7 = document.createElement("div");
		span1.appendChild(div7);
		div7.setAttribute("class", "mdl-tooltip");
		div7.setAttribute("data-mdl-for", "lading_listItem_name"+mdl_id++);
		...
		img3.setAttribute("id", "lading_listItem_address"+mdl_id);
		img3.setAttribute("src", "images/lading_listItem_address.png");
		var div10 = document.createElement("div");
		div9.appendChild(div10);
		div10.setAttribute("class", "mdl-tooltip");
		div10.setAttribute("data-mdl-for", "lading_listItem_address"+mdl_id++);
		...
		img4.setAttribute("id", "lading_listItem_updateTime"+mdl_id);
		img4.setAttribute("src", "images/lading_listItem_updateTime.png");
		var div12 = document.createElement("div");
		div11.appendChild(div12);
		div12.setAttribute("class", "mdl-tooltip");
		div12.setAttribute("data-mdl-for", "lading_listItem_updateTime"+mdl_id++);
